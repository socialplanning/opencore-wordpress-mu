...
function wpautop($pee, $br = 1) {
	...
	$allblocks = '(?:table|thead|object|embed|tfoot|caption|colgroup|tbody|tr|td|th|div|dl|dd|dt|ul|ol|li|pre|select|form|map|area|blockquote|address|math|style|input|p|h[1-6]|hr)';
